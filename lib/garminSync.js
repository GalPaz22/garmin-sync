...
import { resolveGarminStore, resolveStoreConfig, STORE_IDENTIFIER } from './garminStore.js';
 ...
 */
export async function runGarminSync({ triggeredBy = 'manual' } = {}) {
  if (activeRun) {
    return { ok: false, skipped: true, error: 'A Garmin update is already running' };
  }
  ...
  activeRun = { dbName, startedAt, triggeredBy };
